...
CREATE TABLE jcc_user
(
    id    BIGINT NOT NULL,
    email VARCHAR(255) NULL,
    CONSTRAINT pk_jcc_user PRIMARY KEY (id)
);
...
ALTER TABLE jc_instructor
    ADD CONSTRAINT FK_JC_INSTRUCTOR_ON_USER FOREIGN KEY (user_id) REFERENCES jcc_user (id);

ALTER TABLE jc_mentor
    ADD CONSTRAINT FK_JC_MENTOR_ON_USER FOREIGN KEY (user_id) REFERENCES jcc_user (id);

ALTER TABLE jc_ta
    ADD CONSTRAINT FK_JC_TA_ON_USER FOREIGN KEY (user_id) REFERENCES jcc_user (id);
